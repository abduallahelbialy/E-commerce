    ...
    <div class="container">
      <div class="row">
        ...
        <div class="banner mt-4">
          <div class="d-flex justify-content-center align-items-center">
            <h3 class="text-center main fw-semibold">Men’s sandals</h3>
          </div>
        </div>
        <div
...
<script>
import sandals from "../FakeDate/products";
...
export default {
  ...
  methods: {
    shuffleSandals() {
      this.sandals = this.sandals.sort(() => Math.random() - 0.5);
    },
    updateDisplayedSandals() {
      this.displayedSandals = this.sandals.slice(0, this.visibleItems);
    },
    loadMore() {
      this.visibleItems += 4;
      this.shuffleSandals();
    ...
    searchProducts() {
      if (this.searchQuery.trim() === "") {
        ...
        this.displayedSandals = this.sandals
          .filter((item) => {
            return (
