    ...
    <div class="container">
      <div class="row">
        ...
        <div class="banner mt-4">
          <div class="d-flex justify-content-center align-items-center">
            <h3 class="text-center main fw-semibold">Slip On</h3>
          </div>
        </div>
        <div
...
<script>
import Slip from "../FakeDate/products";
...
export default {
  ...
  methods: {
    shuffleSandals() {
      this.Slip = this.Slip.sort(() => Math.random() - 0.5);
    },
    updateDisplayedSandals() {
      this.displayedSandals = this.Slip.slice(0, this.visibleItems);
    },
    loadMore() {
      this.visibleItems += 4;
      this.shuffleSandals();
    ...
    searchProducts() {
      if (this.searchQuery.trim() === "") {
        ...
        this.displayedSandals = this.Slip
          .filter((item) => {
            return (
